...
\begin{tikzpicture}[
  ...
  \draw[anno] (4.0, 4.0) -- (4.0, 5.5);   % vertical at peak
  \draw[anno] (4.0, 5.5) -- (5.7, 5.5);   % top extension line
  \draw[anno] (5.2, 4.0) -- (5.7, 4.0);   % bottom extension line
  \draw[dim] (5.5, 4.0) -- (5.5, 5.5);    % dimension arrow
  \node[annolbl, right] at (5.6, 4.75) {Overshoot};
