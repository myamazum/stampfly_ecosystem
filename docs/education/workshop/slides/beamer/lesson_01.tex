...
\begin{frame}{モータ配置 / Motor Layout}
  \begin{center}
    \includegraphics[width=0.45\textwidth]{motor_layout.png}
  \end{center}
...
\begin{frame}{PWM とは / What is PWM?}
  \begin{center}
    \includegraphics[width=0.55\textwidth]{pwm_waveform.png}
  \end{center}

  \vspace{0.3em}

  \begin{itemize}
    \item \textbf{Duty 0\%} = 停止 / \textbf{100\%} = 最大回転
    \item StampFly API: \api{motor\_set\_duty(id, 0.0\textasciitilde1.0)}
  \end{itemize}
\end{frame}
