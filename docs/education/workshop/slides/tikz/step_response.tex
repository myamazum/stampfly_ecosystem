...
\begin{tikzpicture}[
  ...
  \draw[resp] (0, 0) -- (2, 0)
    ...
    -- (12, 4.0);
  \node[font=\small\bfseries, respcolor, below right] at (9, 4.2) {Response};
  ...
  \node[font=\scriptsize, annocolor, right] at (10, 3.6) {$\pm 5\%$ band};

  % Title
  \node[font=\Large\bfseries, labelcolor, anchor=south] at (6, 6.8)
    {Step Response};
