...
\begin{tikzpicture}[
  ...
  % Title
  \node[font=\Large\bfseries, arrowcolor, above=8mm of P]
    {PID Controller};

  % Labels
  \node[font=\small, pcolor, right] at (8.5, 2) {Proportional};
  \node[font=\small, icolor, right] at (8.5, 0.5) {Integral};
  \node[font=\small, dcolor, right] at (8.5, -2) {Derivative};
