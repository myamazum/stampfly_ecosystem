...
| 項目 | 要件 |
|------|------|
| PC | Python 3.10〜3.12（推奨3.12）が動作する Windows/macOS/Linux |
...
| Item | Requirement |
|------|------------|
| PC | Windows/macOS/Linux with Python 3.10-3.12 (3.12 recommended) |
...
|------|---------|---------|
| Python | 3.10-3.12 (3.12 recommended) | Development language |
