...
# 直近7日間のコミットをまとめる（1週間の進捗）
/post-progress -day 7

# 直近3日間のコミット、プレビューのみ
/post-progress -day 3 --dry-run

# ユーザーメッセージを冒頭に追加
/post-progress -day 7 -m "年末年始の開発成果をまとめました。"

# formalスタイルで投稿
/post-progress -n 10 --style formal

# ユーザーメッセージ + カスタマイズした期間
/post-progress -day 14 -m "2週間ぶりの進捗報告です" --dry-run
```
