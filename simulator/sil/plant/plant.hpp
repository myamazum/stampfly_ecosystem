...
public:
    ...
    struct Config {
        ...
        /// セットとは独立。
        /// Phase 1 (2026-07-26): sourced from generated_params.hpp (sil_params::adopted::KAPPA),
        /// generated by `sf params generate` from control/models/stampfly_physical.yaml
        /// (calibration_sets.measured_2026_07.params.kappa_adopted) -- bit-identical to the
        /// prior hand-written literal 6.12e-3f.
        /// Phase 1（2026-07-26）: generated_params.hpp（sil_params::adopted::KAPPA）由来。
        /// `sf params generate` が control/models/stampfly_physical.yaml
        /// （calibration_sets.measured_2026_07.params.kappa_adopted）から生成——
        /// 従来の手書きリテラル 6.12e-3f とビット一致。
        float kappa    = sil_params::adopted::KAPPA;  ///< Cq/Ct [m]  (reaction torque Q = kappa·T), measured 2026-07-15
        ...
        // 従い独立して更新する。
        // Phase 1 (2026-07-26): motor_Rm/motor_Km now source from generated_params.hpp
        // (sil_params::adopted::RM/KM), generated by `sf params generate` from
        // control/models/stampfly_physical.yaml -- bit-identical to the prior literals.
        // Phase 1（2026-07-26）: motor_Rm/motor_Km は generated_params.hpp
        // （sil_params::adopted::RM/KM）由来。`sf params generate` が
        // control/models/stampfly_physical.yaml から生成——従来のリテラルとビット一致。
