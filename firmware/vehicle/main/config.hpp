...
inline constexpr float BARO_CHI2_GATE = 0.0f;          // 気圧計 disabled (same P-collapse issue as ToF)
inline constexpr float TOF_CHI2_GATE = 0.0f;           // ToF disabled (P_pos collapses→6cm gate→all rejected)
